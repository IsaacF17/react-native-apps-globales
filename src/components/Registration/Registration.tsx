        ...
        <View style={styles.container}>
            <Text style={styles.title}>Registro</Text>
                ...
                <Controller
                    ...
                    defaultValue=""
                />
                {errors.confirmPass?.type === "required" && <Text style={styles.error}>Este campo es requerido</Text>}
                <TouchableOpacity
                    style={styles.button}
                ...
                <View>
                    <Text style={styles.footerText}>Ya tengo una cuenta.<Text onPress={onFooterLinkPress} style={styles.footerLink}> Iniciar sesión</Text></Text>
                </View>
        </View>
    );
}